    ...
    "Focm": [function(require, module, exports) {
        ...
        var o = function() {
            function n(i) {
                ...
                d.textContent = "Accordez-moi votre confiance et laissez-moi influencer votre état d'esprit",
...
function animateButton() {
    ...
    // Animation du bouton (déplacement vers la droite)
    button.style.transition = "margin-left 0.5s ease";
    button.style.marginLeft = "50px";

    // Changement du texte
    changingText.textContent = "malheureusement  !";
...
function getRandomColor() {
    var colors = ["#e74c3c", "#2ecc71", "#f39c12", "#3498db", "#9b59b6", "#34495e"];
    return colors[Math.floor(Math.random() * colors.length)];
}

// Changer la couleur du fond à chaque rafraîchissement de la page
...
function animateButton() {
    ...
    // Changement du texte
    changingText.textContent = " Dans l'obscurité silencieuse de la nuit, une ombre inconnue glisse furtivement le long des murs de votre chambre, murmurant des secrets que seul le vent semble comprendre.";
